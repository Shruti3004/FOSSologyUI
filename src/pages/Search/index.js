...
const Search = () => {
  ...
  return (
    <div className="main-container my-3">
      <div className="row">
        <div className="col-lg-8 col-md-10 col-sm-12 col-12 bg-white home-box-shadow">
          <form>
            <InputContainer
              value="directory"
              name="searchType"
            ...
            <div className="font-demi mt-4">
              You may also choose one or more odivtional search filters (not
              case sensitive).
            </div>
            <InputContainer
              ...
              {searchResult.map((file, index) => (
                <div key={index} className="card p-3 mt-2">
                  <div className="font-demi">
                    {index + 1}. Folder: {file.upload.foldername}
                  </div>
